...
<div class="container py-5 position-relative">
    ...
    <div class="row mb-5">
        <div class="col-12 text-center">
            ...
            <p class="text-light mt-2 fs-5">Admin Panel</p>
        </div>
    </div>
    ...
    <div class="row align-items-center min-vh-100">
        <div class="col-lg-6">
            <div class="hero-content">
                <h1 class="display-3 fw-bold text-white mb-3 futura-font">Admin Access</h1>
                <p class="lead mb-4 text-white fs-2 fw-light poppins-font">Secure Login for Administrators</p>
                <p class="text-light mb-4 fs-5 poppins-font">Access the admin dashboard to manage users, challenges, and system settings.</p>

                <div class="mt-4">
                    <a href="{{ route('home') }}" class="btn btn-outline-light btn-lg shadow-sm hover-grow">
        ...
        <div class="col-lg-6">
            <div class="content-card bg-oweru-light rounded-4 p-5 shadow-lg">
                <h3 class="text-center text-oweru-dark mb-4 futura-font">Admin Login</h3>
