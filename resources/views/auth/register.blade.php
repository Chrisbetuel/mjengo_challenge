    ...
    <div class="row align-items-center min-vh-100">
        <div class="col-lg-6">
            <div class="hero-content">
                <h1 class="display-3 fw-bold text-white mb-3 futura-font">Join Mjengo Challenge</h1>
                <p class="lead mb-4 text-white fs-2 fw-light poppins-font">Start Your Construction Journey Today</p>
                <p class="text-light mb-4 fs-5 poppins-font">Create your account and begin building your dream through collective savings.</p>
        ...
        <div class="col-lg-6">
            <div class="content-card bg-oweru-light rounded-4 p-5 shadow-lg">
                <h3 class="text-center text-oweru-dark mb-4 futura-font">Create Your Account</h3>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        <label for="email" class="block text-oweru-dark text-sm font-bold mb-2 futura-font">Email</label>
                    ...
                    <div class="mb-4">
                        <label for="phone" class="block text-oweru-dark text-sm font-bold mb-2 futura-font">Phone Number</label>
                    ...
                    <div class="mb-4">
                        <label for="password_confirmation" class="block text-oweru-dark text-sm font-bold mb-2 futura-font">Confirm Password</label>
